    ...
    >
      <div className="space-y-8">
        ...
        <button
          ...
          className="w-full bg-red text-white px-8 py-4 font-serif text-sm tracking-wide hover:bg-red-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
